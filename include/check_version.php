...
$yakpro_mtm_base_directory   = dirname(realpath($argv[0]));
$php_parser_git_commandline = 'git clone --branch=1.x https://github.com/nikic/PHP-Parser.git';

if(!file_exists("$yakpro_mtm_base_directory/PHP-Parser/composer.json"))
{
...
$t_composer             = json_decode(file_get_contents("$yakpro_mtm_base_directory/PHP-Parser/composer.json"));   //print_r($t_composer);
